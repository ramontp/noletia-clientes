...
$(document).ready(function(){
	...
	$('a[href*="borra"]').click(function(){
		var confirma = "";
		if (objeto == 'Cliente'){
			confirma="Vas a eliminar un cliente y todos los contactos asociados. ¿Estás seguro?";
	...
	if (showBuscador == 'true'){
		...
		$("#form1").prop('action','buscaCliente');
...
function validaform(){
	...
	if ($("#empresa").val() == ''){
		l=false;
		error1="<li>El campo 'Empresa' no puede estar vacío</li>";
		ul.append(error1);
	}
